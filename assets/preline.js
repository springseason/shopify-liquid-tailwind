              ...
              return (
                ...
                (e.prototype.show = function () {
                  ...
                  this.el.classList.add('active'),
                    (this.content.style.display = 'twcss-block'),
                    ...
                    (0, r.afterTransition)(this.content, function () {
                      (t.content.style.display = 'twcss-block'),
                        (t.content.style.height = ''),
                        t.fireEvent('twcss-open', t.el),
                ...
                (e.show = function (t) {
                  ...
                  e &&
                    'twcss-block' !== e.element.content.style.display &&
                    e.element.show();
                }),
                (e.hide = function (t) {
                  var e = window.$hsAccordionCollection.find(function (e) {
              ...
              return (
                ...
                (e.prototype.init = function () {
                  ...
                  this.createCollection(window.$hsCollapseCollection, this),
                    this.el.addEventListener('click', function () {
                      t.content.classList.contains('twcss-open')
                        ? t.hide()
                        : t.show();
                    });
                }),
                (e.prototype.hideAllMegaMenuItems = function () {
                  this.content
                    ...
                    .forEach(function (t) {
                      t.classList.remove('twcss-block'),
                        t.classList.add('twcss-hidden');
                    });
                }),
                (e.prototype.show = function () {
                  var t = this;
                  if (
                    ...
                    this.el.classList.contains('twcss-open')
                  )
                    return !1;
                  (this.animationInProcess = !0),
                    this.el.classList.add('twcss-open'),
                    this.content.classList.add('twcss-open'),
                    this.content.classList.remove('twcss-hidden'),
                    (this.content.style.height = '0'),
                    setTimeout(function () {
                      t.content.style.height = ''.concat(
                        t.content.scrollHeight,
                ...
                (e.prototype.hide = function () {
                  ...
                  if (
                    ...
                    return !1;
                  (this.animationInProcess = !0),
                    this.el.classList.remove('twcss-open'),
                    (this.content.style.height = ''.concat(
                      this.content.scrollHeight,
                      'px',
                    )),
                    ...
                    this.content.classList.remove('twcss-open'),
                    (0, r.afterTransition)(this.content, function () {
                      t.content.classList.add('twcss-hidden'),
                        (t.content.style.height = ''),
                ...
                (e.show = function (t) {
                  ...
                  e &&
                    e.element.content.classList.contains('twcss-hidden') &&
                    e.element.show();
                }),
                (e.hide = function (t) {
                  var e = window.$hsCollapseCollection.find(function (e) {
            ...
            u = (function (t) {
              ...
              return (
                ...
                (e.prototype.onClickHandler = function () {
                  this.el.classList.contains('twcss-open') &&
                  !this.menu.classList.contains('twcss-hidden')
                    ? this.close()
                    : this.open();
                }),
                ...
                (e.prototype.destroyPopper = function () {
                  this.menu.classList.remove('twcss-block'),
                    this.menu.classList.add('twcss-hidden'),
                ...
                (e.prototype.open = function () {
                  var t = this;
                  if (this.el.classList.contains('twcss-open')) return !1;
                  ...
                  'static' !== o &&
                    ...
                    this.menu.classList.remove('twcss-hidden'),
                    this.menu.classList.add('twcss-block'),
                    setTimeout(function () {
                      t.el.classList.add('twcss-open'),
                        (t.animationInProcess = !1);
                    }),
                    this.fireEvent('twcss-open', this.el),
                ...
                (e.open = function (t) {
                  ...
                  e &&
                    e.element.menu.classList.contains('twcss-hidden') &&
                    e.element.open();
                }),
                (e.close = function (t) {
                  var e = window.$hsDropdownCollection.find(function (e) {
                ...
                (e.accessibility = function (t) {
                  ...
                  var e = window.$hsDropdownCollection.find(function (t) {
                    return t.element.el.classList.contains('twcss-open');
                  });
                  if (
                    e &&
                  ...
                  var n =
                    ...
                    o = n
                      ? window.$hsDropdownCollection.filter(function (t) {
                          return (
                            t.element.el.classList.contains('twcss-open') &&
                            t.element.menu
                              .closest('.hs-dropdown')
          ...
          var s = n(969),
            l = (function (t) {
              function e(e, n, o) {
                ...
                return (
                  (a.hiddenClass =
                    (null == d ? void 0 : d.hiddenClass) || 'twcss-hidden'),
                  (a.isClosePrev =
              ...
              return (
                ...
                (e.prototype.buildBackdrop = function () {
                  ...
                  a ||
                    (o &&
                      ((i = document
                        .querySelector(o)
                        .cloneNode(!0)).classList.remove('twcss-hidden'),
                ...
                (e.prototype.open = function () {
                  ...
                  n && (document.body.style.overflow = 'twcss-hidden'),
                    this.buildBackdrop(),
                    this.checkTimer(),
                    this.hideAuto(),
                    ...
                    setTimeout(function () {
                      if (t.overlay.classList.contains(t.hiddenClass))
                        return !1;
                      t.overlay.classList.add('twcss-open'),
                        t.fireEvent('twcss-open', t.el),
                ...
                (e.accessibility = function (t) {
                  var e,
                    ...
                    o = window.$hsOverlayCollection.filter(function (t) {
                      return t.element.overlay.classList.contains('twcss-open');
                    }),
                    i = o[o.length - 1],
                    r =
                      null ===
                      ...
                      (0, a.debounce)(function (e) {
                        (t.val = e.target.value),
                          t.val.length > t.minChars
                            ...
                            : (t.result = []),
                          t.result.length
                            ? t.dropdown.classList.remove('twcss-hidden')
                            : t.dropdown.classList.add('twcss-hidden'),
                          t.buildItems(),
                  ...
                  (this.dropdown.innerHTML = ''),
                    this.result.forEach(function (e) {
                      var n = (0, a.htmlToElement)(
                        '<a class="twcss-block" href="'.concat(
                          e.url,
                          '" target="_blank"></a>',
                        ),
                      );
              ...
              return (
                ...
                (e.prototype.setToggleIcon = function () {
                  ...
                  if (((n.innerHTML = ''), n)) {
                    ...
                    n.append(o),
                      o
                        ? n.classList.remove('twcss-hidden')
                        : n.classList.add('twcss-hidden');
                  }
                }),
                ...
                (e.prototype.buildDropdown = function () {
                  ...
                  (this.dropdown = (0, l.htmlToElement)(
                    ...
                    this.isOpened ||
                      this.dropdown.classList.add('twcss-hidden'),
                    this.dropdownClasses &&
                      (0, l.classToClassList)(
                        this.dropdownClasses,
                        this.dropdown,
                ...
                (e.prototype.destroy = function () {
                  ...
                  this.el.classList.remove('twcss-hidden'),
                ...
                (e.prototype.open = function () {
                  ...
                  if (this.animationInProcess) return !1;
                  (this.animationInProcess = !0),
                    this.dropdown.classList.remove('twcss-hidden'),
                ...
                (e.prototype.close = function () {
                  ...
                  (this.animationInProcess = !0),
                    ...
                    (0, l.afterTransition)(this.dropdown, function () {
                      o.dropdown.classList.add('twcss-hidden'),
                        o.hasSearch &&
                          ((o.search.value = ''),
              ...
              return (
                  ...
                  (this.weakness =
                    ...
                    'popover' === this.mode &&
                      (this.target.addEventListener('focus', function () {
                        (t.isOpened = !0),
                          t.hints.classList.remove('twcss-hidden'),
                          t.hints.classList.add('twcss-block'),
                      ...
                      this.target.addEventListener('blur', function () {
                        (t.isOpened = !1),
                          ...
                          t.hints.classList.add('twcss-hidden'),
                ...
                (e.prototype.checkIfPassed = function (t, e) {
                  ...
                  e
                    ? (t.classList.add('active'),
                      n.classList.remove('twcss-hidden'),
                      o.classList.add('twcss-hidden'))
                    : (t.classList.remove('active'),
                      n.classList.add('twcss-hidden'),
                      o.classList.remove('twcss-hidden'));
                }),
              ...
              return (
                ...
                (e.prototype.open = function (t) {
                  (this.prev = this.current),
                    ...
                    this.prevContent.classList.add('twcss-hidden'),
                    this.current.classList.add('active'),
                    this.currentContent.classList.remove('twcss-hidden'),
